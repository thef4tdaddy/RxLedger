    ...
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        <form className="space-y-6">
          ...
          {/* Symptoms */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-3">Symptoms (select all that apply)</label>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {[
                ...
                <label key={symptom} className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-50 cursor-pointer">
